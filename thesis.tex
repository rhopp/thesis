...
Dalším krokem ve vývoji Teiid modulu pro komunikaci se SimpleDB by bylo zaměření se na výkon, sepsání \uv{performance testů}. Také je možnost pokusit se začlenit tutoriál vyvinutý v rámci této práce mezi oficiální \uv{quickstarty}\footnote{https://github.com/teiid/teiid-quickstarts}.
\nocite{*}
