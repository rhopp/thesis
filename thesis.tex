...
Pro získání těchto hodnot je implementována statická metoda \texttt{getColumnsValuesMap(Insert insert)}, která instanciuje vlastní třídu předá ji objektu \texttt{Insert} jako návštěvníka, který ji projde. Následně vrátí získané hodnoty.
